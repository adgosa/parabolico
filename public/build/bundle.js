...
var app = (function () {
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			p = element("p");
    			t = text(/*text*/ ctx[0]);
    			attr_dev(p, "class", "answer-text svelte-h4eeqd");
    			add_location(p, file$6, 5, 4, 85);
    			attr_dev(div, "class", "answer flex svelte-h4eeqd");
    ...
    function create_else_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			attr_dev(div, "class", "icon flex svelte-1oxyoo1");
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "expansion-container flex svelte-1oxyoo1");
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			t = text(t_value);
    			attr_dev(div, "class", "answer wrong-answer svelte-1oxyoo1");
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			t = text(t_value);
    			attr_dev(div, "class", "answer chosen-answer svelte-1oxyoo1");
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			t = text(t_value);
    			attr_dev(div, "class", "answer valid-answer svelte-1oxyoo1");
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h2, "class", "index svelte-1oxyoo1");
    			add_location(h2, file$5, 36, 8, 941);
    			attr_dev(p, "class", "question svelte-1oxyoo1");
    			add_location(p, file$5, 38, 12, 1041);
    			attr_dev(div0, "class", "question-container flex svelte-1oxyoo1");
    			add_location(div0, file$5, 37, 8, 990);
    			attr_dev(div1, "class", "icon flex expand svelte-1oxyoo1");
    			add_location(div1, file$5, 40, 8, 1107);

    			attr_dev(div2, "class", div2_class_value = "container flex " + (/*hasAnsweredCorrectly*/ ctx[0]
    			? 'correct'
    			: 'incorrect') + " " + (/*expanded*/ ctx[6] ? '' : 'margin') + " svelte-1oxyoo1");
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "id", "play");
    			attr_dev(div0, "class", "elements-container svelte-1xyd475");
    			add_location(div0, file$2, 155, 4, 5173);
    			attr_dev(div1, "class", "outer-box svelte-1xyd475");
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t7 = space();
    			p = element("p");
    			p.textContent = "Podrás responder 10 preguntas. Cuando hayas terminado, se te\r\n                mostrarán los resultados.";
    			t9 = space();
    			section2 = element("section");
    			create_component(quizsection.$$.fragment);
    			attr_dev(h1, "class", "main-title svelte-1bxcfdm");
    			add_location(h1, file$1, 7, 12, 190);
    			attr_dev(h20, "class", "main-subtitle svelte-1bxcfdm");
    			add_location(h20, file$1, 8, 12, 242);
    			attr_dev(a, "class", "play-btn svelte-1bxcfdm");
    			attr_dev(a, "href", "#quiz");
    			add_location(a, file$1, 11, 12, 361);
    			attr_dev(main, "class", "main svelte-1bxcfdm");
    			add_location(main, file$1, 6, 8, 157);
    			attr_dev(section0, "class", "main-container flex svelte-1bxcfdm");
    			add_location(section0, file$1, 5, 4, 110);
    			attr_dev(h21, "class", "play-title svelte-1bxcfdm");
    			add_location(h21, file$1, 16, 12, 515);
    			attr_dev(p, "class", "play-paragraph svelte-1bxcfdm");
    			add_location(p, file$1, 17, 12, 572);
    			attr_dev(div0, "class", "how-to-play-container flex svelte-1bxcfdm");
    			add_location(div0, file$1, 15, 8, 461);
    			attr_dev(section1, "class", "svelte-1bxcfdm");
    			add_location(section1, file$1, 14, 4, 442);
    			attr_dev(section2, "id", "quiz");
    			attr_dev(section2, "class", "quiz-section flex svelte-1bxcfdm");
    			add_location(section2, file$1, 23, 4, 775);
    			attr_dev(div1, "class", "container flex svelte-1bxcfdm");
